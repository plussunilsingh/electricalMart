    ...
    <div className="max-w-6xl mx-auto py-8">
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <div className="flex-grow space-y-6">
              ...
              {cart.map((item) => (
                ...
                >
                  ...
                  <div className="flex-grow text-center sm:text-left">
                    ...
                    <h3 className="font-bold text-secondary text-lg mb-1 leading-tight">
                      {item.name}
                    </h3>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="text-right min-w-[100px]">
                      <span className="block text-sm text-gray-400 font-medium uppercase tracking-wider text-[10px]">
                        Subtotal
                      </span>
          ...
          <Link
            to="/"
            className="inline-flex items-center space-x-2 text-gray-500 hover:text-secondary font-bold transition-colors group"
          >
        ...
        <div className="lg:w-96">
          <div className="bg-secondary text-white rounded-3xl p-8 shadow-2xl sticky top-24">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex justify-between text-gray-400">
                <span>Shipping</span>
                <span className="text-green-400 font-bold uppercase text-[10px] tracking-widest mt-1">
            ...
            <p className="mt-8 text-xs text-gray-500 text-center leading-relaxed">
              * Final price may vary based on shipping, taxes, and availability. We will contact you
              via your preferred channel to confirm the order.
            </p>
          </div>
        </div>
      </div>
