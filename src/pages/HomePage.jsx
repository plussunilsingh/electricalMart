          ...
          {filteredProducts.length > 0 ? (
            <>
              <div className="flex justify-between items-center mb-6">
                <p className="text-gray-500 font-medium">
                  Showing {Math.min(filteredProducts.length, itemsPerPage)} of{' '}
            ...
            <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-gray-200">
              ...
              <p className="text-gray-500 max-w-xs mx-auto mb-6">
                We couldn't find any products matching your search criteria. Try a different term or
                category.
              </p>
              <button
                onClick={() => {
      ...
      {showFilters && (
        <div className="fixed inset-0 z-[60] lg:hidden">
          ...
          <div className="absolute top-0 right-0 bottom-0 w-80 bg-white shadow-2xl p-6 overflow-y-auto animate-in slide-in-from-right duration-300">
            ...
            <div className="space-y-8">
              <div>
                <h4 className="font-bold text-gray-400 uppercase tracking-widest text-xs mb-4">
                  Categories
                </h4>
                <div className="flex flex-col space-y-2">
                  <button
